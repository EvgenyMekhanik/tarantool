...
/**
 * Calculate size of buffer enought to save compressed data from
 * data array from @a ttc structure.
 */
int64_t
mp_sizeof_for_compression(const struct tt_compression *ttc);

/**
 * Calculate size of buffer enought to save decompressed data from
 * compressed data array from @a ttc structure.
 */
int64_t
